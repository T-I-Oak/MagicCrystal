...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **左右移動** | A D / ← → | 4 / 6 | ◀ / ▶ | 十字 / L-Stick | 左右に歩きます（逆入力で1F反転） |
| **ジャンプ** | **W / ↑** | **8** | **▲** | **十字キー上** | 向いている方向にジャンプ |
| **スマートジャンプ** | **Q / E** | **7 / 9** | **↖ / ↗** | **L1 / R1** | 指定した方向にジャンプ（1F反転可）|
| **向き反転** | **S / ↓ / Bボタン** | **2 / 5 / 3**| **▼ / B** | **十字キー下 / B** | その場で反転し移動をロックします |
| **穴掘り** | **Space / Z** | **1** | **A** | **A (0)** | 足元の土を掘ります |
| **リタイア** | **X長押し** | **3長押し** | **B長押し** | **B (1)長押し** | ライフを失い再開します |
...
- **向き反転 (down / cancel)**:
  - その場でキャラクターの向きを180度反転させます。
  - **移動ロック機能**: 押し続けている間は他の移動入力を受け付けないため、誤って歩き出すのを防げます。
- **穴掘り (confirm)**:
  - 足元が「土」の場合にのみ実行可能です。
  - 決定ボタン（Z / Space / A）に集約され、方向キーとは分離されました。
- **リタイア (cancel 長押し)**:
